...
public class degDistNetwork extends JFrame {
	...
	// has the GUI prints
	public degDistNetwork() {
		setTitle("The full degree distribution");
		...
		for (int i=0; i<noNodes; i++)
		{
			...
			noDegrees[degree]++;
                ...
                jt.append("The full degree distribution: " + "\n");
                for (int j=0; j<=max; j++)
		{                       
			jt.append(j + "]" + "\t" + noDegrees[j] + "\n");
		}
		pack();
	}
